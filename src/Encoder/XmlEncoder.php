...
class XmlEncoder implements  EncoderInterface, DecoderInterface {
  ...
  public function encode($data, $format, array $context = array())
  {
    ...
    if (array_search('error', array_keys($data[0]))) {
      $context['xml_root_node_name'] = "error";

    } elseif (array_search('metadata', array_keys($data[0]))){
      $context['xml_root_node_name'] = "services";

    } else {
      $context['xml_root_node_name'] = "service_request";
